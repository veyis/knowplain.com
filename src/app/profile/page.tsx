        ...
        <div>
          ...
          {!simulations || simulations.length === 0 ? (
            <div className="rounded-2xl border border-line bg-surface p-8 text-center">
              <p className="mb-4 text-sm text-muted">You haven&apos;t saved any simulations yet.</p>
              <Link href="/tools/withdrawal-simulator" className="kp-btn-primary">
                Try the Simulator
              </Link>
            </div>
          ) : (
                ...
                <div key={sim.id} className="flex flex-col justify-between rounded-xl border border-line bg-surface p-5 shadow-xs transition-shadow hover:shadow-sm">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                      ...
                      <div className="text-muted">Withdrawal:</div>
                      ...
                      <div className="text-muted">Inflation:</div>
        ...
        <div>
          <div className="rounded-2xl border border-line bg-surface p-6 shadow-xs">
            ...
            <form action={updateProfileName} className="grid gap-3">
              ...
              />
              <button type="submit" className="kp-btn-primary w-full justify-center">
                Save Changes
              </button>
            </form>
          </div>
