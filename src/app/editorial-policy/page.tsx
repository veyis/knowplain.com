    ...
    <AppShell active="home">
      <article className="max-w-[680px]">
        ...
        <p className="mb-4 leading-relaxed text-foreground/80">
          ...
          <a href="https://www.ssa.gov/" className="text-brand hover:underline" rel="noopener noreferrer">
            Social Security Administration
          </a>
          , the{" "}
          <a href="https://www.irs.gov/" className="text-brand hover:underline" rel="noopener noreferrer">
            IRS
          </a>
        ...
        <p className="mb-4 leading-relaxed text-foreground/80">
          ...
          <a href="https://www.youtube.com/@explainstudio9" className="text-brand hover:underline" rel="noopener noreferrer">
            YouTube channel
          </a>{" "}
